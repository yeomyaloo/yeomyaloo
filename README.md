...
<td style="width: 25%;"> 🖥Visual Studio + HTML + CSS + JAVASCRIPT🖥 </td>
</tr>
<tr>
...
<tr>
<td style="width: 25%;"> Object orientation </td>
...
<ul>
  <li> android studio - application implemented 🏕Camping Reservation application🏕 (2021.03 ~ 2021.06.21)</li>
  <li> 정보처리기사(2021.07~2021.10)</li>
  <li> Python & Django를 이용한 어플구현(2021.09~완성까지) <li>
  </ul>
...
<tbody>
<tr style = "color: grey;">
<td style="width: auto; font-weight:bold;"> Project Name </td>
<td style="width: auto;"> Part </td>
<td style="width: auto;"> Date </td>
<td style="width: auto;"> Develope Tool </td>
<td style="width: auto;"> Language </td>
